...
export default function NewPortfolioProjectPage() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        setSaving(true)
        setError('')
        const { error: err } = await supabase.from('website_projects').insert({
            title: form.title,
            slug: form.slug,
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                    <h1 className="text-3xl font-heading font-semibold text-text-primary">New Portfolio Project</h1>
                    <p className="text-text-secondary font-body">Add a project to your website</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
                ...
                <div className="card-flat space-y-5">
                    ...
                    <div>
                        ...
                        />
                        <p className="text-xs text-text-secondary mt-1">Used in the URL: /portfolio/{form.slug || 'slug'}</p>
                    </div>
                ...
                <div className="card-flat space-y-4">
                    ...
                    <p className="text-sm text-text-secondary -mt-2">Paste image URLs. The first image will be used as the cover.</p>
                ...
                <div className="card-flat space-y-4">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-text-secondary">Show this project prominently on the homepage</p>
                        </div>
                    </label>
                    <label className="flex items-center gap-3 cursor-pointer">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-text-secondary">Make this project visible on the website</p>
                        </div>
                    </label>
                </div>
