                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
                    ...
                    >
                        ...
                        <p className="text-foreground/70 text-lg leading-relaxed max-w-2xl font-body">
                            Behind the Design is our curated 12-page guide featuring material palettes, spatial planning tips, and an inside look at how we approach every project. It&apos;s free.
                        </p>
                    </motion.div>
